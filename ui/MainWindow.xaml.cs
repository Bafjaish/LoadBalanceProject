...
using LoadBalanceProject.db;
using LoadBalanceProject.Computations;
using LoadBalanceProject.Coverage;
using LoadBalanceProject.Parameters;
using LoadBalanceProject.Charts;
using LoadBalanceProject.DataPacket;
using LoadBalanceProject.Properties;
using System.Windows.Media;
using LoadBalanceProject.Logs;
using LoadBalanceProject.ui.conts;
using System.Data;
using LoadBalanceProject.ExpermentsResults;
using System.Windows.Threading;
using LoadBalanceProject.Forwarding;
using LoadBalanceProject.ExpermentsResults.Energy_consumptions;
using LoadBalanceProject.ExpermentsResults.Lifetime;
    ...
    public partial class MainWindow : Window
    {
        ...
        private void TimerCounter_Tick(object sender, EventArgs e)
        {
            ...
            if (PublicParamerters.SimulationTime <= stopSimlationWhen + PublicParamerters.MacStartUp)
            {
                ...
                Title = "LoadBalanceProject:" + PublicParamerters.SimulationTime.ToString();
            }
            else
            {
                TimerCounter.Stop();
