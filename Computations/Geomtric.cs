...
namespace LoadBalanceProject.Computations
{
    ...
    public class Geomtric
    {
        ...
        {
            //AP × AB
            Vector AP = new Computations.Vector() { P1= T.A, P2= P };
            Vector AB = new Computations.Vector() { P1 = T.A, P2 = T.B };
            double APAB = CrossProduct(AP, AB);
            // BP × BC
            Vector BP = new Computations.Vector() { P1 = T.B, P2 = P };
            Vector BC = new Computations.Vector() { P1 = T.B, P2 = T.C };
            double BPBC = CrossProduct(BP, BC);
            //CP × CA
            Vector CP = new Computations.Vector() { P1 = T.C, P2 = P };
            Vector CA = new Computations.Vector() { P1 = T.C, P2 = T.A };
        ...
        {
            Triangle T1 = new Computations.Triangle() { A = Para.P1, B = Para.P2, C = Para.P3 };
            Triangle T2 = new Computations.Triangle() { A = Para.P2, B = Para.P3, C = Para.P4 };
